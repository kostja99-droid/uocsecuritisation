...
cat("  list_categories()\n")
cat("\nTo scrape external sources (Rada, SBU):\n")
cat("  source('02_scrape_external.R')\n")
cat("  rada_docs <- scrape_rada(DATE_START, DATE_END)\n")
cat("  sbu_docs  <- scrape_sbu(DATE_START, DATE_END)\n")
cat("  # Or all at once:\n")
cat("  all_ext   <- scrape_external_all(DATE_START, DATE_END)\n")
